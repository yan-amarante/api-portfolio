...
exports.registerProjects = exports.listProjects = void 0;
...
function listProjects(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const projects = yield project_1.default.find().populate('tecnologias');
...
function registerProjects(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const project = yield project_1.default.create(values);
